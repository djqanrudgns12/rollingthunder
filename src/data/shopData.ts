...
export const MOCK_ITEMS: ShopItem[] = [
  ...
  // 상점 판매
  { item_id: "piece_windmill", category: "piece", name: "풍차", price: 2000, rarity: "Rare", description: "일정 속도로 회전하며 경로를 방해합니다.", image: "/images/assets/obstacles/obstacle_windmill.png", requiresPremium: true },
  { item_id: "piece_piston", category: "piece", name: "피스톤", price: 2000, rarity: "Rare", description: "주기적으로 튀어나와 강제로 밀어냅니다.", image: "/images/assets/obstacles/obstacle_piston.png", requiresPremium: true },
  { item_id: "piece_windcannon", category: "piece", name: "송풍기", price: 5000, rarity: "Epic", description: "특정 방향으로 바람을 일으켜 밀어냅니다.", image: "/images/assets/obstacles/obstacle_blower.png", requiresPremium: true },
  { item_id: "piece_portal", category: "piece", name: "포탈", price: 5000, rarity: "Epic", description: "진입한 공을 즉시 이동시킵니다.", image: "/images/assets/obstacles/obstacle_portal.png", requiresPremium: true },
  { item_id: "piece_luckygate", category: "piece", name: "럭키게이트", price: 10000, rarity: "Legendary", description: "점수나 효과를 부여하는 특수 게이트입니다.", image: "", iconName: "Trophy", requiresPremium: true },
  ...
  // 판매
  { item_id: "frame_grass", category: "frame", name: "잔디 숲", price: 3000, rarity: "Rare", description: "자연의 기운을 담은 잔디 벽입니다.", image: "/images/assets/obstacles/obstacle_wall_grass.png", requiresPremium: true },
  { item_id: "frame_ice", category: "frame", name: "빙하 얼음", price: 3000, rarity: "Rare", description: "차가운 얼음 형태의 벽입니다.", image: "/images/assets/obstacles/obstacle_wall_ice.png", requiresPremium: true },
  { item_id: "frame_toxic", category: "frame", name: "맹독 지대", price: 3000, rarity: "Rare", description: "오염된 맹독이 흐르는 벽입니다.", image: "/images/assets/obstacles/obstacle_wall_toxic.png", requiresPremium: true },
  { item_id: "frame_lava", category: "frame", name: "용암 대장간", price: 3000, rarity: "Rare", description: "뜨거운 열기가 느껴지는 벽입니다.", image: "/images/assets/obstacles/obstacle_wall_lava.png", requiresPremium: true },
  { item_id: "frame_candy", category: "frame", name: "캔디 랜드", price: 5000, rarity: "Epic", description: "달콤한 과자 모양의 벽입니다.", image: "/images/assets/obstacles/obstacle_wall_candy.png", requiresPremium: true },
  { item_id: "frame_arcade", category: "frame", name: "레트로 아케이드", price: 5000, rarity: "Epic", description: "고전 게임 스타일의 벽입니다.", image: "/images/assets/obstacles/obstacle_wall_arcade.png", requiresPremium: true },
  { item_id: "frame_matrix", category: "frame", name: "매트릭스", price: 5000, rarity: "Epic", description: "디지털 데이터가 흐르는 벽입니다.", image: "/images/assets/obstacles/obstacle_wall_matrix.png", requiresPremium: true },
  { item_id: "frame_steampunk", category: "frame", name: "스팀펑크", price: 5000, rarity: "Epic", description: "톱니바퀴가 돌아가는 기계 장치 벽입니다.", image: "/images/assets/obstacles/obstacle_wall_steampunk.png", requiresPremium: true },
  { item_id: "frame_crystal", category: "frame", name: "수정 동굴", price: 5000, rarity: "Epic", description: "빛나는 수정이 박힌 벽입니다.", image: "/images/assets/obstacles/obstacle_wall_crystal.png", requiresPremium: true },
  { item_id: "frame_gothic", category: "frame", name: "고딕 호러", price: 8000, rarity: "Legendary", description: "으스스한 분위기의 벽입니다.", image: "/images/assets/obstacles/obstacle_wall_gothic.png", requiresPremium: true },
  { item_id: "frame_space", category: "frame", name: "심우주", price: 8000, rarity: "Legendary", description: "우주의 신비로움을 담은 벽입니다.", image: "/images/assets/obstacles/obstacle_wall_space.png", requiresPremium: true },
  { item_id: "frame_gold", category: "frame", name: "황금 신전", price: 8000, rarity: "Legendary", description: "고급스러운 황금빛 벽입니다.", image: "/images/assets/obstacles/obstacle_wall_gold.png", requiresPremium: true },
  { item_id: "frame_plasma", category: "frame", name: "플라즈마 에너지", price: 15000, rarity: "Mythic", description: "에너지가 요동치는 벽입니다.", image: "/images/assets/obstacles/obstacle_wall_plasma.png", requiresPremium: true },
  ...
  // 판매
  { item_id: "bg_portal_labyrinth", category: "background", name: "차원 포탈 미궁", price: 4000, rarity: "Rare", description: "신비로운 차원 문이 펼쳐진 배경입니다.", image: "/images/assets/map_bg_portal_labyrinth.png", requiresPremium: true },
  { item_id: "bg_plinko_cascade", category: "background", name: "플링코 폭포", price: 4000, rarity: "Rare", description: "구슬이 떨어지는 플링코 폭포입니다.", image: "/images/assets/map_bg_plinko_cascade.png", requiresPremium: true },
  { item_id: "bg_roulette_of_fate", category: "background", name: "운명의 룰렛", price: 4000, rarity: "Rare", description: "행운을 가늠하는 룰렛 배경입니다.", image: "/images/assets/map_bg_roulette_of_fate.png", requiresPremium: true },
  { item_id: "bg_tornado_canyon", category: "background", name: "토네이도 협곡", price: 4000, rarity: "Rare", description: "바람이 거세게 부는 계곡입니다.", image: "/images/assets/map_bg_tornado_canyon.png", requiresPremium: true },
  { item_id: "bg_bounce_mirror", category: "background", name: "바운스 미러", price: 4000, rarity: "Rare", description: "거울의 방을 닮은 배경입니다.", image: "/images/assets/map_bg_bounce_mirror.png", requiresPremium: true },
  { item_id: "bg_meteor_field", category: "background", name: "미티어 필드", price: 4000, rarity: "Rare", description: "운석이 떨어지는 우주 전장입니다.", image: "/images/assets/map_bg_meteor_field.png", requiresPremium: true },
  { item_id: "bg_enchanted_forest", category: "background", name: "요정의 숲", price: 4000, rarity: "Rare", description: "요정들이 춤추는 신비한 숲입니다.", image: "/images/assets/bg_enchanted_forest_1782785674317.jpg", requiresPremium: true },
  { item_id: "bg_desert_oasis", category: "background", name: "사막 오아시스", price: 4000, rarity: "Rare", description: "건조한 사막 한가운데의 오아시스입니다.", image: "/images/assets/bg_desert_oasis_1782785682635.jpg", requiresPremium: true },
  { item_id: "bg_icy_glacier_cavern", category: "background", name: "빙하 동굴", price: 4000, rarity: "Rare", description: "차갑고 웅장한 빙하 동굴입니다.", image: "/images/assets/bg_icy_glacier_cavern_1782785635405.jpg", requiresPremium: true },
  { item_id: "bg_lava_volcano_core", category: "background", name: "용암 지대", price: 4000, rarity: "Rare", description: "펄펄 끓는 용암이 흐르는 화산입니다.", image: "/images/assets/bg_lava_volcano_core_1782785625035.jpg", requiresPremium: true },
  
  { item_id: "bg_cyberpunk_megacity", category: "background", name: "사이버펑크 시티", price: 8000, rarity: "Epic", description: "미래 도시의 화려한 야경입니다.", image: "/images/assets/bg_cyberpunk_megacity_1782785606020.jpg", requiresPremium: true },
  { item_id: "bg_virtual_matrix_grid", category: "background", name: "가상 매트릭스", price: 8000, rarity: "Epic", description: "데이터가 흐르는 가상 매트릭스 공간입니다.", image: "/images/assets/bg_virtual_matrix_grid_1782785744588.jpg", requiresPremium: true },
  { item_id: "bg_toxic_wasteland", category: "background", name: "오염 구역", price: 8000, rarity: "Epic", description: "위험한 화학물질로 오염된 구역입니다.", image: "/images/assets/bg_toxic_wasteland_1782785654564.jpg", requiresPremium: true },
  { item_id: "bg_candy_land", category: "background", name: "캔디 랜드", price: 8000, rarity: "Epic", description: "달콤한 과자로 만들어진 세상입니다.", image: "/images/assets/bg_candy_land_1782785710474.jpg", requiresPremium: true },
  { item_id: "bg_cyber_dystopia", category: "background", name: "사이버 디스토피아", price: 8000, rarity: "Epic", description: "사이버네틱한 절망의 도시입니다.", image: "/images/assets/bg_cyber_dystopia.png", requiresPremium: true },
  { item_id: "bg_neon_synthwave_ultra", category: "background", name: "네온 신스웨이브", price: 8000, rarity: "Epic", description: "레트로 퓨처리즘 감성의 배경입니다.", image: "/images/assets/bg_neon_synthwave_ultra.png", requiresPremium: true },
  { item_id: "bg_retrowave_sunset", category: "background", name: "레트로 선셋", price: 8000, rarity: "Epic", description: "아름다운 노을을 배경으로 한 레트로 풍경입니다.", image: "/images/assets/bg_retrowave_sunset_1782785719122.jpg", requiresPremium: true },
  { item_id: "bg_steampunk_factory", category: "background", name: "스팀펑크 공장", price: 8000, rarity: "Epic", description: "증기와 기계가 맞물려 돌아가는 공장입니다.", image: "/images/assets/bg_steampunk_factory_1782785664737.jpg", requiresPremium: true },
  { item_id: "bg_frozen_tundra", category: "background", name: "혹한의 툰드라", price: 8000, rarity: "Epic", description: "얼어붙은 차가운 설원입니다.", image: "/images/assets/bg_frozen_tundra_1782785823149.jpg", requiresPremium: true },
  { item_id: "bg_galactic_highway", category: "background", name: "은하계 도로", price: 8000, rarity: "Epic", description: "별빛 사이를 관통하는 우주 하이웨이입니다.", image: "/images/assets/bg_galactic_highway_1782785832121.jpg", requiresPremium: true },

  { item_id: "bg_deep_space_nebula", category: "background", name: "심우주 성운", price: 15000, rarity: "Legendary", description: "신비로운 우주의 성운입니다.", image: "/images/assets/bg_deep_space_nebula_1782785644285.jpg", requiresPremium: true },
  { item_id: "bg_haunted_gothic_castle", category: "background", name: "고딕 성", price: 15000, rarity: "Legendary", description: "어둠에 잠긴 무서운 뱀파이어 성입니다.", image: "/images/assets/bg_haunted_gothic_castle_1782785727034.jpg", requiresPremium: true },
  { item_id: "bg_celestial_clockwork", category: "background", name: "천체 시계장치", price: 15000, rarity: "Legendary", description: "우주의 시간을 관장하는 시계 장치입니다.", image: "/images/assets/bg_celestial_clockwork.png", requiresPremium: true },
  { item_id: "bg_pirate_ship_deck", category: "background", name: "해적선 갑판", price: 15000, rarity: "Legendary", description: "거친 파도를 항해하는 해적선 갑판입니다.", image: "/images/assets/bg_pirate_ship_deck_1782785840910.jpg", requiresPremium: true },
  { item_id: "bg_samurai_dojo", category: "background", name: "사무라이 도장", price: 15000, rarity: "Legendary", description: "벚꽃이 흩날리는 무사의 도장입니다.", image: "/images/assets/bg_samurai_dojo_1782785850135.jpg", requiresPremium: true },
  { item_id: "bg_abyssal_trench", category: "background", name: "심해 해구", price: 15000, rarity: "Legendary", description: "아무것도 보이지 않는 심해 깊은 곳입니다.", image: "/images/assets/bg_abyssal_trench.png", requiresPremium: true },
  { item_id: "bg_quantum_realm_178", category: "background", name: "양자 영역", price: 15000, rarity: "Legendary", description: "미시 세계의 복잡하고 신비로운 양자 영역입니다.", image: "/images/assets/bg_quantum_realm_1782785877783.jpg", requiresPremium: true },
  { item_id: "bg_post_apocalyptic_ruins", category: "background", name: "아포칼립스", price: 15000, rarity: "Legendary", description: "멸망 이후의 쓸쓸한 폐허입니다.", image: "/images/assets/bg_post_apocalyptic_ruins_1782785753197.jpg", requiresPremium: true },

  { item_id: "bg_golden_temple", category: "background", name: "황금 신전", price: 30000, rarity: "Mythic", description: "황금으로 덮여 반짝이는 신전입니다.", image: "/images/assets/bg_golden_temple_1782785887745.jpg", requiresPremium: true },
  { item_id: "bg_celestial_sky_palace", category: "background", name: "천상의 궁전", price: 30000, rarity: "Mythic", description: "구름 위에 떠 있는 신들의 궁전입니다.", image: "/images/assets/bg_celestial_sky_palace_1782785761515.jpg", requiresPremium: true },
  { item_id: "bg_bioluminescent_jungle", category: "background", name: "생물발광 정글", price: 30000, rarity: "Mythic", description: "빛을 내는 식물들로 가득한 정글입니다.", image: "/images/assets/bg_bioluminescent_jungle_1782785780805.jpg", requiresPremium: true },
  { item_id: "bg_abstract_geometric_void", category: "background", name: "기하학적 추상", price: 30000, rarity: "Mythic", description: "규칙적이고 추상적인 기하학 공간입니다.", image: "/images/assets/bg_abstract_geometric_void_1782785788732.jpg", requiresPremium: true },
  { item_id: "bg_floating_islands", category: "background", name: "부유하는 섬", price: 30000, rarity: "Mythic", description: "하늘에 둥둥 떠있는 섬들입니다.", image: "/images/assets/bg_floating_islands_1782785867391.jpg", requiresPremium: true },
  { item_id: "bg_ancient_mystic_ruins", category: "background", name: "고대 유적", price: 30000, rarity: "Mythic", description: "잊혀진 문명의 신비로운 유적지입니다.", image: "/images/assets/bg_ancient_mystic_ruins_1782785615064.jpg", requiresPremium: true },
  { item_id: "bg_alien_planet_surface", category: "background", name: "외계 행성", price: 30000, rarity: "Mythic", description: "미지의 생명체가 살 법한 외계 행성입니다.", image: "/images/assets/bg_alien_planet_surface_1782785858731.jpg", requiresPremium: true },
