      ...
      <div className="relative z-10 flex items-center justify-between">
        <div>
          <h3 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-br from-green-300 to-emerald-600 drop-shadow-sm flex items-center gap-2">
            Lucky Roulette <Sparkles size={20} className="text-yellow-400" />
          </h3>
          <p className="text-neutral-400 text-sm mt-1">Spin to win Legendary items or Jackpots!</p>
        </div>
        
        <button className="px-6 py-2 bg-gradient-to-r from-green-600 to-emerald-800 text-white font-bold rounded-full shadow-[0_0_15px_rgba(16,185,129,0.3)] hover:shadow-[0_0_20px_rgba(16,185,129,0.5)] transition-all">
          500 C
        </button>
      </div>
    </div>
